...
function App() {
  ...
  const listRecommendations = (recommendation) => setRecommendations(recommendation);

  /**
   * Dadas atualizações no formulário, necessário atualizar a lista de recomendações
   * -------------------------------------------------------------------------------
   * ATUALIZAÇÃO DA LISTA DE RECOMENDAÇÕES
   * -------------------------------------------------------------------------------
   * A lista de recomendações é atualizada com base nas seleções feitas no formulário.
   * Através da funcção listRecommendations, é possível obter os dados retornados do formulário é atribui-los à propriedade recommendations.
   * Isso garante que a lista de recomendações seja atualizada sempre que o formulário for enviado.
   */
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col justify-center items-center">
      ...
      <div className="bg-white p-8 rounded-lg shadow-md w-full md:w-3/4 lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          <Form listRecommendations={listRecommendations}/>
        </div>
        <div>
